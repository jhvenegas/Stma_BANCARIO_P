...
namespace Stma_BANCARIO_P.Capa_COORDINACION
{
     class clsCONTROLADOR
    {
        ...
        public void crudRegistrarObjAlcancia(int pOIDBanco, int pOIDAhorrador, int pOID, string pNombre)
        {
            ...
            varInstanciaServidorCrud.crudRegistrarObj(varBanco, varAhorrador,varAhorrador.GetObjsAlcancias(), varBanco.GetObjsAlcancias(),  pOID, pNombre);
        }
        #endregion
        #region 2.4.2: Actualizadores   
        public void crudActualizarObjAhorrador(int pOIDBANCO,int pOIDPersona, int pOID,string pFechaInicio)
        {
            clsBANCO varBanco =(clsBANCO) clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOIDBANCO, this.atrColObjsBancos);
            clsPERSONA varPersona =(clsPERSONA) clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOIDPersona, this.atrColObjsPersonas);
            clsSERVIDOR_CRUD_AHORRADOR varInstanciaServidorCrud = clsSERVIDOR_CRUD_AHORRADOR.ObtenerInstancia();
            varInstanciaServidorCrud.crudActualizarObj(varBanco.GetObjsAhorradores(), varPersona.GetObjsAhorradores(), pOID, pFechaInicio);
        }
        public void crudActualizarObjAlcancia(int pOIDBANCO,int pOIDAhorrador, int pOID, string pNombre)
        {
            clsBANCO varBanco= (clsBANCO)clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOIDBANCO, this.atrColObjsBancos);
            clsAHORRADOR varAhorrador=(clsAHORRADOR)clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOIDAhorrador,varBanco.GetObjsAhorradores());
            clsSERVIDOR_CRUD_ALCANCIA varInstanciaServidorCrud = clsSERVIDOR_CRUD_ALCANCIA.ObtenerInstancia();
            varInstanciaServidorCrud.crudActualizarObj(varBanco.GetObjsAlcancias(), varAhorrador.GetObjsAlcancias(), pOID, pNombre);      
         }
        ...
        public void crudActualizarObjBillete(int pOID, string pValorEnLetras, int pDenominacion,int pAño,int pMes, int pDia)
        {
            clsSERVIDOR_CRUD_BILLETE varInstanciaServidorCrud = clsSERVIDOR_CRUD_BILLETE.ObtenerInstancia();
            ArrayList varColDineros = atrObjTesoro.GetColDinero();
            varInstanciaServidorCrud.crudActualizarObj(varColDineros,pOID,pValorEnLetras,pDenominacion,pAño,pMes,pDia);
        }
        public void crudActualizarObjMoneda(int pOID, string pValorEnLetras, int pDenominacion, int pAño)
        {
            clsSERVIDOR_CRUD_MONEDA varInstanciaServidorCrud = clsSERVIDOR_CRUD_MONEDA.ObtenerInstancia();
            ArrayList varColDineros = atrObjTesoro.GetColDinero();
            varInstanciaServidorCrud.crudActualizarObj(varColDineros, pOID, pValorEnLetras, pDenominacion, pAño);
        }
        #endregion
        #region 2.4.3: Eliminadores
        public void crudEliminarObjBanco(int pOID)
         {
             clsSERVIDOR_CRUD_BANCO varInstanciaServidorCrud = clsSERVIDOR_CRUD_BANCO.ObtenerInstancia();
             clsCUENTA varTesoroPuente= (clsCUENTA)this.atrObjTesoro;
             varInstanciaServidorCrud.crudEliminarObj(this.atrColObjsBancos, pOID, ref varTesoroPuente);
             this.atrObjTesoro = (clsTESORO)varTesoroPuente;
         }
        ...
        public void TransferenciaTesoroBoveda(int pOIDBancoDestino,Type pTipo, int pDenominacion)
        {
            ...
            this.atrObjTesoro.Transferencia(varBanco.GetObjBoveda(), pTipo, pDenominacion);
        }
