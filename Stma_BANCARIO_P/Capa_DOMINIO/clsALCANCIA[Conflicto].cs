...
namespace Stma_BANCARIO_P.Capa_DOMINIO
{
    class clsALCANCIA : clsCUENTA
    {
        ...
        public clsALCANCIA() { }
        public clsALCANCIA(clsAHORRADOR pObjCreador2,clsBANCO pObjCreador1,int pOID, string pNombre):base(pOID, pNombre)
        {
        ...
        public void Liquidar()
        {
            ...
            clsBILLETERA varBilleteraPrimerAhorrador = varAhorrador.GetObjPersona().GetObjBilletera();
            clsDINERO varObjeto;
            for (int varPosicion = 0; varPosicion < this.atrColObjsDineros.Count; varPosicion++)
            {
                ...
                this.Transferencia(varBilleteraPrimerAhorrador, varTipo, varDemoninacion);
            }
        }
        #endregion
        #endregion
