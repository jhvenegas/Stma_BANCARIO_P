...
namespace Stma_BANCARIO_P.Capa_DOMINIO
{
    class clsTRANSACCION : clsOBJETO
    {
        ...
        public clsTRANSACCION(clsCUENTA pObjCuentaOrigen, clsCUENTA pObjCuentaDestino, int pOID, string pNombre, clsDINERO pObjDinero)
            : base(pOID, pNombre)
        {
            this.atrFecha = "Hoy";
        ...
        {
            clsSERVIDOR_ASOCIACIONES.DisociarObjCon(this, this.atrObjCuentaOrigen.GetColObjsTransacciones());
            clsSERVIDOR_ASOCIACIONES.DisociarObjCon(this, this.atrObjCuentaDestino.GetColObjsTransacciones());
            clsSERVIDOR_ASOCIACIONES.DisociarObjCon(this, this.atrObjDinero.GetColObjsTransacciones());
        }
        #endregion
