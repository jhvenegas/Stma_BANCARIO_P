...
namespace Stma_BANCARIO_P.Capa_SERVICIOS
{
    class clsSERVIDOR_CRUD
    {
        ...
        public virtual void Destruir(object pObjeto,ref clsCUENTA pTesoroLiquidacion)
        {
        }
        #endregion
        ...
        {
            //Situación muchos as uno contra dos creadores. Con referencias a estos úlitmos.
            object varObjeto = clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOID, pColeccion2);
            if (varObjeto == null)
            {
        ...
        public void crudEliminarObj(ArrayList pColeccion, int pOID, ref clsCUENTA pCuentaLiquidacion)
        {
            //1. Buscar-Encontrar y Recuperar el Objeto a Eliminar con OID
            object varObjeto = clsSERVIDOR_ASOCIACIONES.ObtenerObjCon(pOID, pColeccion);
            if (varObjeto != null)
            {
                clsSERVIDOR_ASOCIACIONES.DisociarObjCon(varObjeto, pColeccion);
                this.Destruir(varObjeto, ref pCuentaLiquidacion);
                varObjeto = null;
                clsGESTOR_RECURSOS.LiberarRecursos("DotNet");
            }
        }
        ...
        public void crudEliminarObj(object pObjAtributo, ref clsCUENTA pCuentaLiquidacion)
        {
            if (pObjAtributo != null)
            {
                this.Destruir(pObjAtributo, ref pCuentaLiquidacion);
                clsGESTOR_RECURSOS.LiberarRecursos("DotNet");
            }
        }
